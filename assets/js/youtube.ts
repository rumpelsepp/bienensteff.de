class YoutubePlayer extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (localStorage.getItem("ytConsent") ?? false) {
            ...
            disclaimer.textContent = "Der \"Player laden\" Button aktiviert den YouTube Player und zugehörige Cookies.\n Der \"In YouTube öffnen\" Button leitet auf die externe Seite YouTube weiter.";
            ...
            consentButton.textContent = "Player laden";
            ...
            openInYoutube.textContent = "In YouTube öffnen";
    ...
    loadPlayer() {
        const videoId = this.getAttribute("video-id")
        const innerHTML = '<iframe src="https://www.youtube-nocookie.com/embed/' + videoId + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
